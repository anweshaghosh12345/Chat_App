...
public class SettingsActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
               ...
               String status= setting_status.getText().toString();
                ...
                if(selimageUri !=null){
                    ...
                    storageReference.putFile(selimageUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode ==10){
            if(data!= null){
                selimageUri = data.getData();
                settings_image.setImageURI(selimageUri);
            }
        }
    }
